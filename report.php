...
require_once("$CFG->dirroot/local/sc_learningplans/tables/report_lp_table.php");
...
$pageurl = new moodle_url('/local/sc_learningplans/report.php', ['id' => $learningplanid]);
...
if (!$table->is_downloading()) {
    ...
    $PAGE->set_title(get_string('report', 'local_sc_learningplans'));
    $PAGE->set_heading(get_string('report', 'local_sc_learningplans'));
    echo $OUTPUT->header();
}
