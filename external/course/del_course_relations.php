...
class del_course_relations_external extends external_api {

    public static function del_course_relations_parameters() {
    ...
    public static function del_course_relations($recordid, $records) {
        global $DB, $USER;
        ...
        foreach ($records as $newrecord) {
            $DB->execute("DELETE FROM {local_learningplan_rel_cours}
                WHERE origin_record_id = $newrecord AND destination_record_id = $recordid");
            $DB->execute("DELETE FROM {local_learningplan_rel_cours}
                WHERE origin_record_id = $recordid AND destination_record_id = $newrecord");
        }
    ...
    public static function del_course_relations_returns() {
